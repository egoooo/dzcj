...
public class DeviceDataBean {
    ...
    public class Device
    {
        ...
        private RelationProject relationProject;
        ...
        public void setRelationProject(RelationProject relationProject){
            this.relationProject = relationProject;
        }
        public RelationProject getRelationProject(){
        ...
        public void setBmHeight(String bmHeight){
            this.bmHeight = bmHeight;
        }
        public String getBmHeight(){
    ...
    public class List
    {
        ...
        public void setHeightDifference(String heightDifference){
